...
**GKE Deployment:**
Created a 2-node cluster on GKE with e2-small machines. Cost about $44/month but covered by the $300 free credits. Changed the readiness probe from HTTP to TCP because the backend root path was giving 404s. Had to bump disk size to 20GB cause GKE images need atleast 12GB.

**Live URL:**
http://34.121.63.230 - deployed on GKE and working. Frontend talks to backend, backend talks to MongoDB, everything persists cause of the StatefulSet volumes.
